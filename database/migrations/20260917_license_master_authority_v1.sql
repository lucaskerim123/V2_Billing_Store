...
-- Runtime contract: https://customlicensev1.vercel.app
...
VALUES
  (gen_random_uuid(),'OrbitFS Base','orbitfs-base','orbitfs_base',true,'AUD','https://customlicensev1.vercel.app','master',true,'automatic','{"license_authority":"orbitfs-license-master-v2"}'::jsonb),
  (gen_random_uuid(),'OrbitFS APEX','orbitfs-apex','orbitfs_apex',true,'AUD','https://customlicensev1.vercel.app','master',true,'automatic','{"license_authority":"orbitfs-license-master-v2"}'::jsonb),
  (gen_random_uuid(),'OrbitFS MCP','orbitfs-mcp','orbitfs_mcp',true,'AUD','https://customlicensev1.vercel.app','master',true,'automatic','{"license_authority":"orbitfs-license-master-v2"}'::jsonb),
  (gen_random_uuid(),'OrbitFS Studio','orbitfs-studio','orbitfs_studio',true,'AUD','https://customlicensev1.vercel.app','master',true,'automatic','{"license_authority":"orbitfs-license-master-v2"}'::jsonb)
...
SET api_name='OrbitFS Licence API',
    base_url='https://customlicensev1.vercel.app',
    mode='master',
    enabled=true,
    validation_path='/api/v1/licenses/validate',
    registration_path='/api/v1/licenses',
    activation_path='/api/license/{id}/control',
    revision_path='/api/license/v1/health',
    health_path='/api/license/v1/health',
...
SELECT 'OrbitFS Licence API','https://customlicensev1.vercel.app','master',true,'/api/v1/licenses/validate','/api/v1/licenses','/api/license/{id}/control','/api/license/v1/health','/api/license/v1/health','orbitfs-license-master','orbitfs-runtime',3600,0,5,false
WHERE NOT EXISTS (SELECT 1 FROM public.license_api_settings);

UPDATE public.license_master_connection
SET master_url='https://customlicensev1.vercel.app',
    enabled=true,
    last_error=NULL,
    updated_at=now()
