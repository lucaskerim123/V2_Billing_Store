...
const ALLOWED_PREFIXES=["/api/health","/api/v1","/api/licenses","/api/license","/api/products","/api/installations","/api/releases","/api/deployments","/api/settings","/api/release-capture","/api/release-control","/api/release-handoff","/api/release-automation-settings"];
