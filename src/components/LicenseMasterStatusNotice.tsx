...
export default function LicenseMasterStatusNotice(){
  ...
  const label=state.reason==="maintenance"?"License Master maintenance":state.reason==="api_disabled"?"License Master API disabled":state.reason==="licensing_disabled"?"License issuance disabled":"License Master unavailable";
