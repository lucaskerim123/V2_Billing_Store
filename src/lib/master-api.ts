...
export async function masterExecuteDeployment(input:any){return masterRequest("/api/deployer/v1",{method:"POST",body:JSON.stringify({...input,phase:input.phase||"authorize"})},"deployer");}
export async function masterSyncDeployment(input:any){return masterRequest("/api/deployer/v1",{method:"POST",body:JSON.stringify({...input,phase:"sync"})},"deployer");}
